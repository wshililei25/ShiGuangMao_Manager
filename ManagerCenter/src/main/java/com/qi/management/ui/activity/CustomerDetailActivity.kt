 ...
 * 顾客详情
 */
class CustomerDetailActivity : BaseMvpActivity<StaffDetailsPresenter>(), StaffDetailsView, View.OnClickListener {
    ...
    private fun initView() {
        ...
        mUserInfo = intent.getParcelableExtra<UserInfo>(BaseConstant.KEY_CUSTOMER)
        with(mUserInfo) {
            mUserIv.loadUrl(imgurl)
            mNameTv.text = nickname
            mMobileTv.text = mobile
        }
